    ...
    children: [
      // user
      {
        ...
        children: [
          ...
          {
            path: '/user/system-academy',
            name: 'AcademyList',
            component: () => import(/* webpackChunkName: "result" */ '@/views/user/AcademyList'),
            meta: { title: '学院列表', keepAlive: false, hiddenHeaderContent: true, permission: ['result'] }
          }
        ]
      },
      // dashboard
