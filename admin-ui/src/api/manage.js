...
export function getAcademyList (parameter) {
  return axios({
    url: api.academy,
    method: 'get',
    params: parameter
...
export function createAcademy (parameter) {
  return axios({
    url: api.academy,
    method: 'post',
    data: parameter
...
export function updateAcademy (parameter) {
  return axios({
    url: api.academy,
    method: 'put',
    data: parameter
...
export function deleteAcademy (data) {
  return axios({
    method: 'delete',
    url: api.academy,
    data: data
